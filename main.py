...
class App(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        ctk.CTkLabel(header, text="v1.2",
                     font=FONT_SMALL, text_color=COLOR_SUBTEXT).pack(side="right", padx=20, pady=15)

        # ── Frame principal con scroll ──────────────────────────────────────────
        # CAMBIO: CTkScrollableFrame para que la sección "Tecla de Activación"
        # sea visible aunque el contenido supere la altura de la ventana.
        ...
        self.status_label = ctk.CTkLabel(
            main, text="● Inactivo — presiona la tecla asignada para iniciar",
            font=FONT_SMALL, text_color=COLOR_SUBTEXT,
        )
